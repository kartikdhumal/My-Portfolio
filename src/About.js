...
import stylish from './images/IMG-20230104-WA0020.jpg'
...
function About() {
  ...
  return (
    <div dir='ltr' className='w-100 justify-between font-medium text-lg flex-col self-center items-center '>
       ...
       <img src={stylish} className='stylishimg xl:w-1/3 xl:h-auto mt-10 sm:w-3/4 sm:h-2/3 rounded-full shadow-2xl grayscale' ></img>
